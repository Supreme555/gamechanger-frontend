...
export default function LoginForm({ className = '' }: LoginFormProps) {
  ...
  return (
    <div className={className}>
      ...
      {/* Заголовок */}
      <div className="text-center mb-6">
        <h2 className={`text-xl font-semibold ${isMobileWhite ? 'text-white' : 'text-gray-900'}`}>Вход</h2>
      </div>
      ...
      <div className="mt-6">
        <div className="text-center">
          <Link 
            href="#" 
            className={`text-sm ${isMobileWhite ? 'text-gray-300 hover:text-gray-200' : 'text-gray-500 hover:text-gray-700'}`}
          >
            Забыли пароль?
          </Link>
        </div>
